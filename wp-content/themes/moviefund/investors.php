...
<div class="container">
<div class="row">
<b><span><a href="<?php echo get_home_url(); ?>">HOME</a></span> >> <a href="<?php echo get_home_url(); ?>/investors/">Investors</a></b>
               </div>
<h2 style="text-align: center; margin-bottom:30px">Investors</h2>
<?php
$i=0;
    $args = array('suppress_filters' => true,'pagepost_category' => 'How It Works','post_type' => 'page_post','order' => 'ASC'
    );
