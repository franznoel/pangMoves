    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12 abt-clt">
                <h5>Our Clients</h5>
                <p>The Movie Fund Client base consists of the industry's major studios, production companies, networks, and individuals.  Our solutions cater to all positions and levels of the industry.</p>
            </div>
        </div>
        <div class="row">
