                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <div class="map">
                                        <a href="<?php echo home_url(); ?>"><img src="<?php echo get_home_url();?>/wp-content/uploads/2015/09/start-map.png" alt="map" /></a>
                                    </div>
                        ...
                        <div class="col-sm-4">
                            ...
                            <form id="contact-form-footer" action="/mailer/" method="POST">
                            <div class="row">
                                <div class="col-sm-6">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <label for="contactMessage">
                                        Your Message
                                        <textarea id="contactMessage" name="contactMessage" class="form-control" rows="4" cols="40"></textarea>
                                    </label>
                                </div>
                            </div>
                                <?php wp_nonce_field(); ?>
                                <input class="btn btn-primary pull-right" type="submit" value="Send" /><img class="ajax-loader" style="visibility: hidden;" src="http://moviefund.com/wp-content/plugins/contact-form-7/images/ajax-loader.gif" alt="Sending ..." />
                            ...
                            <!--
                            <form id="contact-form" action="<?php wp_nonce_url($url,"contact-page"); ?>" method="post" class="wpcf7-form" novalidate="novalidate">
                                <div class="row">
...
?>
        ...
        <footer>
            <div class="get-start-holder" style="background-image:none; background-color:#000;">
                <div class="container">
                <div class="row">
