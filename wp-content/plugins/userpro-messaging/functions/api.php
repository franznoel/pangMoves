...
class userpro_msg_api {
	...
	function email_user($to, $from, $msg) {
		...
		$body .= sprintf(__('You have received a new message on %s from %s','userpro-msg'), userpro_get_option('mail_from_name'), $display_name) . "<br>";
		$body .= sprintf(__('Here is the message body:','userpro-msg')) . "<br>";
		$body .= "==========================================="  . "<br>";
		$body .= $msg  . "<br>";
		$body .= "==========================================="  . "<br>";
		$body .= sprintf(__('To reply to this conversation or read more messages, please view your messages by logging to your profile:','userpro-msg')) . "<br>";
