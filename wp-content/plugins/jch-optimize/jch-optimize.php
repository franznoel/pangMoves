...
function jch_load_lazy_images()
{
        ...
        wp_enqueue_script('jch-lazyload-js', JCH_PLUGIN_URL . 'media/js/pro-jquery.lazyloadxt.js', array('jquery'), JCH_VERSION, TRUE);
...
function jch_transient_update_plugins($transient)
{
        ...
        if (version_compare($new_version, JCH_VERSION, '>'))
        {
                $obj = new stdClass();
                ...
                $obj->package     = html_entity_decode((string) $update->downloads->downloadurl) . '&dlid=' . $dlid;
