        ...
        <div>
                ...
                <form action="options.php" method="post" class="jch-settings-form">
                        <div style="width: 90%;">
                                ...
                                <?php
                                $subscribe_url = 'https://www.jch-optimize.net/subscribe/levels.html/?tab=wordpress';
                                /* ##<freecode>##
                                  ?>
                        ...
                        <ul class="nav nav-tabs">
                                <li><a href="#description" data-toggle="tab"><?php _e('Description', 'jch-optimize') ?></a></li>
                                ...
                                if (version_compare(PHP_VERSION, '5.3.0', '>='))
                                {
                                        ...
                                        <li class="active"><a href="#basic" data-toggle="tab"><?php _e('Basic Options', 'jch-optimize') ?></a></li>
                                        <li><a href="#advanced" data-toggle="tab"><?php _e('Advanced Options', 'jch-optimize') ?></a></li>
                        ...
                        <div class="tab-content">
                                ...
                                <div class="tab-pane active" id="description">
                                        <div id="extension-container" style="text-align:left;">
                                                ...
                                                <p><?php printf(wp_kses(__('To get a more verbose description of the plugin options go <a href="%s" target="_blank">here</a>.', 'jch-optimize'), array('a' => array('href' => array(), 'target' => array()))), esc_url('https://www.jch-optimize.net/documentation/plugin-options.html')); ?></p>
...
function jch_initialize_settings()
{
        ...
        wp_register_style('jch-filetree-css', JCH_PLUGIN_URL . 'media/css/css-lib/pro-jquery.filetree.css', array(), JCH_VERSION);

        wp_register_script('jch-filetree-js', JCH_PLUGIN_URL . 'media/js/js-lib/pro-jquery.filetree.js', array('jquery'), JCH_VERSION, TRUE);
        wp_register_script('jch-proadminutility-js', JCH_PLUGIN_URL . 'media/js/js-lib/pro-admin-utility.js', array('jquery'), JCH_VERSION, TRUE);
        ##</procode>##
        ...
        add_settings_field('jch_options_lifetime', __('Lifetime (days)', 'jch-optimize'), 'jch_options_lifetime_string', 'jch-sections',
                                                      'jch_advanced');
        add_settings_section('jch_advanced_debug', '', 'jch_advanced_debug_section_text', 'jch-sections');
        add_settings_field('jch_options_debug', __('Debug plugin', 'jch-optimize'), 'jch_options_debug_string', 'jch-sections', 'jch_advanced_debug');
        add_settings_field('jch_options_log', __('Log Exceptions', 'jch-optimize'), 'jch_options_log_string', 'jch-sections', 'jch_advanced_debug');
        add_settings_field('jch_options_try_catch', __('Use <span class="notranslate">try-catch</span>', 'jch-optimize'), 'jch_options_try_catch_string', 'jch-sections',
                                                       'jch_advanced_debug');
...
function jch_load_scripts()
{
        ...
        <?php ##<procode>##                                    ?>
                var ajax_url = ajaxurl + '?action=optimizeimages';
                var message = "<?php _e('Please open a directory to optimize images', 'jch-optimize') ?>"
...
function jch_advanced_section_text()
{
  ...
  <div class="tab-pane" id="advanced">';
        ...
        $header = __('Advanced Settings', 'jch-optimize');
...
function jch_advanced_debug_section_text()
{
        jch_group_end();

        $header      = __('Troubleshooting Settings', 'jch-optimize');
        $description = __('These settings are useful for debugging issues with the plugin.', 'jch-optimize');
...
function jch_pro_cookielessdomain_section_text()
{
        ...
        $header      = __('CDN/Cookieless Domain');
...
function jch_options_pro_cookielessdomain_enable_string()
{
        ...
        ##<procode>##
        echo jch_gen_radio_field('pro_cookielessdomain_enable', '0', '');
        ##</procode>##
}
...
function jch_options_pro_cookielessdomain_string()
{
        ...
        ##<procode>##
        echo jch_gen_text_field('pro_cookielessdomain', '', '', '', '30');
        ##</procode>##
}
...
function jch_options_pro_staticfiles_string()
{
        ...
        $values = array('css'   => 'css', 'png'   => 'png', 'gif'   => 'gif', 'ico'   => 'ico', 'pdf'   => 'pdf', 'js'    => 'js', 'jpe?g' => 'jp(e)g',
                'bmp'   => 'bmp',
                'tiff?' => 'tif(f)', 'docx?' => 'doc(x)');

        echo jch_gen_checkboxes_field('pro_staticfiles', $values, $description, 'checkboxes');
        ##</procode>##
}
...
function jch_options_pro_lazyload_string()
{
        ...
        ##<procode>##
        echo jch_gen_radio_field('pro_lazyload', '0', $description);
        ##</procode>##
}
...
function jch_options_pro_optimizeCssDelivery_enable_string()
{
        ...
        ##<procode>##
        echo jch_gen_radio_field('pro_optimizeCssDelivery_enable', '0', '');
        ##</procode>##
}
...
function jch_options_pro_optimizeCssDelivery_string()
{
        ...
        ##<procode>##
        echo jch_gen_select_field('pro_optimizeCssDelivery', '200', $values, '');
        ##</procode>##
}
...
function jch_options_optimize_images_string()
{
        ...
        {       
                ?>
                <div class="error">
                        <p> <?php _e('The PHP setting <span class="notranslate">\'allow_url_fopen\'</span> must be enabled for this feature.', 'jch-optimize'); ?></p>
                </div> 
                <?php
...
{
        echo JchOptimizeAjax::optimizeImages(JchPlatformSettings::getInstance(get_option('jch_options')));
