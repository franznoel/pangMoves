...
class JchOptimizeLinkBuilderBase
{
         ...
         * 
         */
        protected function showLazyLoadImages()
        {
...
class JchOptimizeLinkBuilder extends JchOptimizelinkBuilderBase
{
        ...
        {
                if ($this->params->get('pro_cookielessdomain_enable', '0') && in_array($sType,
                                                                                       $this->params->get('pro_staticfiles',
                                                                                                          array('css', 'js', 'jpe?g', 'gif', 'png', 'ico',
                                        'bmp', 'pdf'))))
                {
...
<noscript><link type="text/css" rel="stylesheet" href="' . $sUrl . '" /></noscript>' . $this->sLnEnd . $this->sTab . '</body>';
